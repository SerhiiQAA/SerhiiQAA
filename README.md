...
[![My Skills](https://skillicons.dev/icons?i=js,ts,py,ai,cypress,git,vscode,androidstudio,githubactions,mysql,jenkins,gherkin,docker,postman,figma,discord,linux&perline=17)](https://skillicons.dev)
